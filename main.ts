...
namespace envirobit {
    ...
    class tcs3472 {
        ...
        constructor(addr: number, leds: DigitalPin = 10) {
            this.is_setup = false
            this.addr = addr
            this.leds = leds
        }
    ...
    export function getTemperature(): number {
        ...
        return _bme280.getTemperature() / 100.0
    }
    ...
    export function getPressure(): number {
        ...
        return _bme280.getPressure() / 100.0
    }
    ...
    export function getHumidity(): number {
        ...
        return _bme280.getHumidity() / 1024.0
    }
    ...
    export function getHumidityFine(): number {
        ...
        return (_bme280.getHumidity() * 100.0) / 1024.0
    }
